...
M569 P20.0 S0                   ; Drive E0
M569 P21.0 S1                   ; Drive E1
M569 P22.0 S0                   ; Drive E2
M569 P23.0 S1                   ; Drive E3
...
M308 S1 P"20.temp0" Y"pt1000" L-25							; Set thermistor
...
M308 S2 P"21.temp0" Y"pt1000" L-25							; Set thermistor
...
M308 S3 P"22.temp0" Y"pt1000" L-25							; Set thermistor
M950 H3 C"22.out0" T3;                                  	; Assign heater
M143 H3 S320                                            	; Set temperature limit for heater 3 to 300C
M307 H3 A559.7 C283.1 D3.5                              	; v6, 30w results from m303 h3 s275

M308 S4 P"23.temp0" Y"pt1000" L-25							; Set thermistor
M950 H4 C"23.out0" T4;                                  	; Assign heater
M143 H4 S320                                            	; Set temperature limit for heater 4 to 300C
M307 H4 A559.7 C283.1 D3.5                              	; v6, 30w results from m303 h4 s275


; Hemera fans
M950 F5 C"20.out2"          ; T0 hot end fan
M106 P5 S255 H1 T70         ; T0 hot end fan temp monitoring

M950 F6 C"21.out2"          ; T1 hot end fan
M106 P6 S255 H2 T70         ; T1 hot end fan temp monitoring

M950 F7 C"22.out2"          ; T2 hot end fan
M106 P7 S255 H3 T70         ; T2 hot end fan temp monitoring

M950 F8 C"23.out2"          ; T3 hot end fan
M106 P8 S255 H4 T70         ; T3 hot end fan temp monitoring
...
G10 P2 X22.75 Y20.3 Z-14.8	            ; Define tool 2 offset
...
M950 J0 C"io4.in"		; tool-detect switch
